...
中文輸入在 Arch-based 系統使用原生 Fcitx 5 + 小麥注音；其他有圖形桌面的 Linux 使用 Flathub Fcitx 5 + 小麥注音，並保留原生 IM module 供 host 應用使用。Fcitx5 僅額外安裝 Catppuccin（圓角）與 Mellow 主題，`update` 會一併更新。
